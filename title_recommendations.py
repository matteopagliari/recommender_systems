'Recommend items for target users based on titles'
...
similarity_title = pd.read_table('/Users/matteopagliari/PycharmProjects/RecSys/Dataset/sim_title_200_test1.csv', delimiter=',')
...
# merge interactions with similarity_title
merging = pd.merge(similarity_title,interactions, how='left', right_on='item_id', left_on='item')
...
np.savetxt("/Users/matteopagliari/PycharmProjects/RecSys/Dataset/title_hybrid_all.csv", recommendations, delimiter=",")
np.savetxt("/Users/matteopagliari/PycharmProjects/RecSys/Dataset/title_hybrid_all_score.csv", recommendations_scores, delimiter=",")
...
def submit(tgt,recoms):
    ...
    submission = open('/Users/matteopagliari/PycharmProjects/RecSys/Submission/title_recommendations_2.csv','w')
